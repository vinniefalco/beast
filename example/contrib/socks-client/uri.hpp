...
public:
    ...
    public:
        ...
        qs_iterator& operator++() noexcept
        {
            increment();
            return *this;
        }

        qs_iterator operator++(int) noexcept
        {
    ...
    struct qs_range
    {
        const qs_iterator begin() const noexcept
        {
            return begin_;
        }

        const qs_iterator end() const noexcept
        {
            return end_;
        }

        const qs_iterator begin_;
        const qs_iterator end_;
    };
